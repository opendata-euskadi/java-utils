...
@Accessors(prefix="_")
public class LatiniaConfig 
  implements ContainsConfigData {
/////////////////////////////////////////////////////////////////////////////////////////
//	FIELDS
/////////////////////////////////////////////////////////////////////////////////////////
	@Getter private final Url _serviceUrl;
...
//	BUILDER  
/////////////////////////////////////////////////////////////////////////////////////////
	public LatiniaConfig(final Url serviceUrl,
	...
	public static LatiniaConfig createFrom(final XMLPropertiesForAppComponent latiniaProps) {
		return LatiniaConfig.createFrom(latiniaProps,
							 			"latinia");
	}
	public static LatiniaConfig createFrom(final XMLPropertiesForAppComponent latiniaProps,
		...
		// [2] - Builde the config
		LatiniaConfig outCfg = new LatiniaConfig(latiniaWSUrl,
												 enterpriseLogin,
