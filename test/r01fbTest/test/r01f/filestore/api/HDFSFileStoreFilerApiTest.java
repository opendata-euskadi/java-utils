 ...
 */
@Accessors(prefix="_")
public class HDFSFileStoreFilerApiTest 
...
//  CONSTRUCTOR
/////////////////////////////////////////////////////////////////////////////////////////
	public HDFSFileStoreFilerApiTest() throws IOException {
		this("local");
	}
	public HDFSFileStoreFilerApiTest(final String env) throws IOException {
		super(ROOT_PATH,
			  new HDFSFileStoreAPI(_buildConfig(env)),
			  new HDFSFileStoreFilerAPI(_buildConfig(env)));
	}
