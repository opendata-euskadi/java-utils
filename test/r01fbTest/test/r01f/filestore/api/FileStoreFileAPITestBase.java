...
/**
 * Test {@link FileStoreAPI}
 */
@Slf4j
public abstract class FileStoreFileAPITestBase {
/////////////////////////////////////////////////////////////////////////////////////////
//  FIELDS
/////////////////////////////////////////////////////////////////////////////////////////
...
//  CONSTRUCTOR
/////////////////////////////////////////////////////////////////////////////////////////
	public FileStoreFileAPITestBase(final Path rootPath,
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void testExistsFile() {
		...
		try {
			Path path = _rootPath.joinedWith("test_file.txt");
			_fileStoreApi.writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
									  path,
									  true);		// overwrite
			_fileStoreApi.existsFile(path);
	...
	public void testExistEmptyPathFile() {
		//Empty test
		try {
			_fileStoreApi.existsFile(new Path());
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IllegalArgumentException e) {
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void testCopyFile() {
		...
		//Null test
		try {
			_fileStoreApi.copyFile(null, null, false);
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
			Assert.fail();
		} catch (IllegalArgumentException e) {
	...
	public void testCopyEmptyPathFile() {
		...
		try {
			_fileStoreApi.copyFile(new Path(), new Path(), false);
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
			Assert.fail(e.getMessage());
		}
	...
	public void testCopyFileToItself() {
		...
		Path path = _fileStoreObjectTest.getRootPath().joinedWith("test_file.txt");
		try {

			_fileStoreObjectTest.getFileStoreApi().writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
										   path,
										   true);		// overwrite
			_fileStoreObjectTest.getFileStoreApi().copyFile(path, path, true);
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		}
		catch (IOException e) {
			Assert.fail(e.getMessage());
	...
	public void testCopyNonExistingFile() {
		...
		Path newPath = _rootPath.joinedWith(newPathString);
		Path path = _rootPath.joinedWith("test_file.txt");
		String fileContent = "This is a copied file";
		try {
			path = _rootPath.joinedWith("test_file.txt");
			_fileStoreApi.writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
									  path,
								      true);		// overwrite

			_fileStoreApi.copyFile(path, 
								   newPath, 
								   true);
		}
		catch (IOException e) {
			...
			try {
				...
				_fileStoreApi.deleteFile(newPath);
			} catch (IOException e) {
				Assert.fail(e.getMessage());
			}
		}
	...
	public void testCopyAndOverriteFile() {
		...
		String newPathString="/test_destination_file.txt";
		Path destinationFilePath = _rootPath.joinedWith(newPathString);
		Path path = _rootPath.joinedWith("test_file.txt");
		String fileContent = "This is a copied file";
		Path newPath = _rootPath.joinedWith(newPathString);
		try {
			...
			_fileStoreApi.writeToFile(new ByteArrayInputStream(destinationFileContent.getBytes()),
									  destinationFilePath,
									  true);		// overwrite

			_fileStoreApi.copyFile(path, newPath, true);
			String readedFileContent=StringPersistenceUtils.load(_fileStoreApi.readFromFile(path));
	...
	public void testCopyAndOverriteToReadOnlyFile() {
		...
		Path path = _fileStoreObjectTest.getRootPath().joinedWith("test_file.txt");
		String newPathString="/test_destination_file.txt";
		Path destinationFilePath = _fileStoreObjectTest.getRootPath().joinedWith(newPathString);
		String fileContent = "This is a copied file";
		Path newPath = _fileStoreObjectTest.getRootPath().joinedWith(newPathString);
		try {
			path = _fileStoreObjectTest.getRootPath().joinedWith("test_file.txt");
			_fileStoreObjectTest.getFileStoreApi().writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
										   path,
										   true);		// overwrite
			String destinationFileContent = "This is a file";

			_fileStoreObjectTest.getFileStoreApi().writeToFile(new ByteArrayInputStream(destinationFileContent.getBytes()),
										   destinationFilePath,
										   true);		// overwrite
			File file1 = new File(destinationFilePath.asAbsoluteString());
			file1.setReadOnly();
			Assert.assertFalse(file1.canWrite());
			_fileStoreObjectTest.getFileStoreApi().copyFile(path, newPath, true);
			Assert.fail("Expected an IOException to be thrown");
			String readedFileContent=StringPersistenceUtils.load(_fileStoreObjectTest.getFileStoreApi().readFromFile(path));
			Assert.assertTrue(fileContent.equals(readedFileContent));
		}
		catch (IOException e) {
			...
			try {
				_fileStoreObjectTest.getFileStoreApi().deleteFile(newPath);
			} catch (IOException e) {
				Assert.fail(e.getMessage());
			}
		}
	...
	public void testRenameNullFile() {
		...
		//Null test
		try {
			_fileStoreApi.renameFile(null,null);
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
			Assert.fail();
		} catch (IllegalArgumentException e) {
	...
	public void testRenameFileToItself() {
		...
		try {
			...
			_fileStoreApi.renameFile(path, path);
			Assert.fail("Expected an IOException to be thrown");
		}
		catch (IOException e) {
	...
	public void testCopyFileAndDontOverrideToExistingFile() {
		//Existing path test
		Path path = _rootPath.joinedWith("/test_file.txt");
		Path newPath = _rootPath.joinedWith("/moved/test_file(copy).txt");
		String fileContent = "This is a copied file";
		...
		try {
			_fileStoreApi.writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
									  path,
									  true);// overwrite
			_fileStoreApi.writeToFile(new ByteArrayInputStream(destinationContent.getBytes()),
									  newPath,
									  true);// overwrite
			_fileStoreApi.copyFile(path, 
								   newPath, 
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void testGetNullFileOutputStreamForWriting() {
		// Null test
		try {
			_fileStoreApi.getFileOutputStreamForWriting(null,
														false); //overwrite
	...
	public void testGetEmpyPathFileOutputStreamForWriting() {
		// Empty test
		try {
			_fileStoreApi.getFileOutputStreamForWriting(new Path(),
														false); //overwrite
	...
	public void testGetExistingFileOutputStreamForWritingAndOverwrite() {
		...
		try {
			...
			_fileStoreApi.writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
									  path,
									  true);		// overwrite
			Assert.assertTrue(_fileStoreApi.existsFile(path));
			OutputStream stream=_fileStoreApi.getFileOutputStreamForWriting(path, 
																			false);
	...
	public void testGetFileOutputStreamForWritingAndDontOverwrite() {
		...
		try {
			String additionalContent=" with aditional text added";
			Assert.assertFalse(_fileStoreApi.existsFile(path));
			OutputStream stream=_fileStoreApi.getFileOutputStreamForWriting(path, 
																			false);
			Assert.assertNotNull(stream);
			stream.write(additionalContent.getBytes());
	...
	public void testCreateFile() throws IOException {
		...
		InputStream fileIs = _fileStoreApi.readFromFile(path);
	...
	public void testWriteNullFile() {
		//Null test
		try {
			_fileStoreApi.writeToFile(null,
								      null,
									  true); // overwrite
			Assert.fail("Expected an IOException to be thrown");
		} catch (IOException e) {
	...
	public void testWriteEmptyPathFile() {
		...
		try {
			_fileStoreApi.writeToFile(new ByteArrayInputStream(new byte[] {}),
									  new Path(),
									  false); // overwrite
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
	...
	public void testWriteInAReadOnlyFile() {
		...
		Path path1 = _fileStoreObjectTest.getRootPath().joinedWith("readOnly_test_file.txt");
		try {
			File file1 = new File(path1.asAbsoluteString());
			file1.setReadOnly();
			Assert.assertFalse(file1.canRead());
			_fileStoreObjectTest.getFileStoreApi().writeToFile(new ByteArrayInputStream(fileContent1.getBytes()),
											   path1,
											   true); // overwrite
			Assert.fail("Expected an IOException to be thrown");
			...
			try {
				_fileStoreObjectTest.getFileStoreApi().deleteFile(path);
				Assert.assertFalse(_fileStoreObjectTest.getFileStoreApi().existsFile(path));
			} catch (IOException e) {
				Assert.fail(e.getMessage());
			}
		}
	...
	public void testGetNullFileOutputStreamForAppending() {
		//Null test
		try {
			_fileStoreApi.getFileOutputStreamForAppending(null); //overwrite
	...
	public void testGetEmptyPathFileOutputStreamForAppending() {
		//Empty test
		try {
			_fileStoreApi.getFileOutputStreamForAppending(new Path());
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
			Assert.fail(e.getMessage());
		}
	...
	public void testGetExistingFileOutputStreamForAppending() {
		...
		try {
			...
			_fileStoreApi.writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
								      ...
								      true);		// overwrite
			Assert.assertTrue(_fileStoreApi.existsFile(path));
			OutputStream stream=_fileStoreApi.getFileOutputStreamForAppending(path);
			Assert.assertNotNull(stream);
			stream.write(additionalContent.getBytes());
			stream.flush();
			stream.close();
	...
	public void testGetNewFileOutputStreamForAppending() {
		...
		try {
			Assert.assertFalse(_fileStoreApi.existsFile(path));
			//String fileContent = StringPersistenceUtils.load(_fileStoreObjectTest.getFileStoreApi().readFromFile(path));
	...
	public void testAppendToFile() {
		...
		try {
			_fileStoreApi.writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
								      path,
								      true); // overwrite
			_fileStoreApi.appendToFile(new ByteArrayInputStream(additionalContent.getBytes()),
									   path); // overwrite
			InputStream fileIs = _fileStoreApi.readFromFile(path);
			String readedFileContent = StringPersistenceUtils.load(fileIs);
	...
	public void testAppendToNullFile() {
		//Null test
		try {
			_fileStoreApi.appendToFile(null,
									   null);
			Assert.fail("Expected an IOException to be thrown");
		} catch (IOException e) {
			Assert.fail(e.getMessage());
	...
	public void testAppendToEmpyPathFile() {
		//Empty (root path, no write permission)
		try {
			_fileStoreApi.appendToFile(new ByteArrayInputStream(new byte[] {}),
									   new Path()); // overwrite
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
			Assert.fail(e.getMessage());
	...
	public void testAppendToReadOnlyFile() {
		...
		try {
			...
			file1.setReadOnly();
			Assert.assertFalse(file1.canRead());
			_fileStoreObjectTest.getFileStoreApi().appendToFile(new ByteArrayInputStream(fileContent1.getBytes()),
											   path1);
			Assert.fail("Expected an IOException to be thrown");
	...
	public void testCreateFileByChunks() throws IOException {
		...
		try {
			...
			_fileStoreApi.appendChunkToFile("This is a ".getBytes(),
										    path);
			StringPersistenceUtils.load(_fileStoreApi.readFromFile(path));

			log.info("\t...FIRST CHUNK OK!!!");
			_fileStoreApi.appendChunkToFile("test file".getBytes(),
										 	path);
	...
	public void testAppendChunkToFile() {
		...
		try {
			_fileStoreApi.writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
									  path,
									  true); // overwrite
			_fileStoreApi.appendChunkToFile(firstChunk.getBytes(),
										    path);
			Assert.assertNotNull(StringPersistenceUtils.load(_fileStoreApi.readFromFile(path)));
			_fileStoreApi.appendChunkToFile(secondChunk.getBytes(),
									 		path);
			String readedFileContent = StringPersistenceUtils.load(_fileStoreApi.readFromFile(path));
	...
	public void testAppendChunkToNullFile() {
		...
		//Null test
		try {
			_fileStoreApi.appendChunkToFile(null,
											null);
				Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
			Assert.fail(e.getMessage());
	...
	public void testAppendChunkToReadOnlyFile() {
		...
		try {
			...
			file1.setReadOnly();
			Assert.assertFalse(file1.canRead());
			_fileStoreObjectTest.getFileStoreApi().appendChunkToFile(firstChunk.getBytes(),
											   path1);
			Assert.fail("Expected an IOException to be thrown");
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void testReadNonExistingFileTest() {
		...
		Path path = _rootPath.joinedWith("test_file.txt");
		try {
			_fileStoreApi.readFromFile(path);
			Assert.fail("Expected an IOException to be thrown");
	...
	public void testReadNullFile() {
		...
		String fileContent = "This is a file file";
		try {
			InputStream fileIs = _fileStoreApi.readFromFile(null);
			Assert.fail("Expected an IOException to be thrown");
			String readedFileContent = StringPersistenceUtils.load(fileIs);
			Assert.assertTrue(fileContent.equals(readedFileContent));
	...
	public void testReadEmptyPathTest() {
		...
		String fileContent = "This is a file file";
		try {
			InputStream fileIs = _fileStoreApi.readFromFile(new Path());
			String readedFileContent = StringPersistenceUtils.load(fileIs);
			Assert.assertTrue(fileContent.equals(readedFileContent));
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
	...
	public void testReadNonAllowedFile() {
		...
		Path path1 = _fileStoreObjectTest.getRootPath().joinedWith("test_file1.txt");
		try {
			_fileStoreObjectTest.getFileStoreApi().writeToFile(new ByteArrayInputStream(fileContent1.getBytes()),
					path1,
					true); // overwrite
			...
			InputStream fileIs = _fileStoreObjectTest.getFileStoreApi().readFromFile(path);
			Assert.fail("Expected an IOException to be thrown");
			String readedFileContent = StringPersistenceUtils.load(fileIs);
			Assert.assertTrue(fileContent.equals(readedFileContent));
			...
			try {
				_fileStoreObjectTest.getFileStoreApi().deleteFile(path1);
				Assert.assertFalse(_fileStoreObjectTest.getFileStoreApi().existsFile(path1));
			} catch (IOException e) {
				Assert.fail(e.getMessage());
			}
		}
	...
	public void testReadChunkFromFile() {
		...
		try {
			...
			byte[] fistReadedChunk = _fileStoreApi.readChunkFromFile(path, 0, firstChunk.length());
			byte[] secondReadedChunk = _fileStoreApi.readChunkFromFile(path, firstChunk.length(), secondChunk.length());
	...
	public void testReadChunkFromNonExistingFile() {
		...
		String firstChunk="This is a ";
		try {
			_fileStoreApi.readChunkFromFile(path,
											0,firstChunk.length());
			Assert.fail("Expected an IOException to be thrown");
	...
	public void testReadChunkFromNullFile() {
		...
		//Null test
		try {
			_fileStoreApi.readChunkFromFile(null, 
											0,0);
			Assert.fail("Expected an IOException to be thrown");
	...
	public void testReadChunkFromEmptyPathFile() {
		...
		String firstChunk="This is a ";
		try {
			_fileStoreApi.readChunkFromFile(new Path(),
											0,firstChunk.length());
	...
	public void testReadChunkFromNotAllowedFile() {
		...
		try {
			...
			_fileStoreObjectTest.getFileStoreApi().readChunkFromFile(new Path(path1.asAbsoluteString()), 0, firstChunk.length());
			Assert.fail("Expected an IOException to be thrown");
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void testNonExistingFilePath() {
		...
		try {
			Assert.assertFalse(_fileStoreApi.existsFile(path));
			Assert.assertTrue(_fileStoreApi.deleteFile(path));
			Assert.fail("Expected an IOException to be thrown");
		} catch (IOException e) {
	...
	public void testDeleteEmptyPathFile() {
		//Empty test
		try {
			Assert.assertTrue(_fileStoreApi.deleteFile(new Path()));
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IllegalArgumentException e) {
			Assert.assertThat(e.getMessage(), CoreMatchers.is("Can not create a Path from an empty string"));
		} catch (IOException e1) {
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void testGetFileProperties() {
		...
		try {
			...
			_fileStoreApi.writeToFile(new ByteArrayInputStream(fileContent.getBytes()),
						   	  		  path,
						   	  		  true); // overwrite
			FileProperties props = _fileStoreApi.getFileProperties(path);
			log.info("\n{}",props.debugInfo());
	...
	public void testGetNullFileProperties() {
		//Null test
		try {
			_fileStoreApi.getFileProperties(null);
			Assert.fail("Expected an IllegalArgumentException to be thrown");
		} catch (IOException e) {
			Assert.fail(e.getMessage());
		}
	...
	public void testGetEmptyPathFileProperties() {
		//Empty test
		try {
			_fileStoreApi.getFileProperties(new Path());
		} catch (IOException e) {
			Assert.fail(e.getMessage());
		}
		catch (IllegalArgumentException e) {
