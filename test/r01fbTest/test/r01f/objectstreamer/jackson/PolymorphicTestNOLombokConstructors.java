...
public class PolymorphicTestNOLombokConstructors {
/////////////////////////////////////////////////////////////////////////////////////////
//	
/////////////////////////////////////////////////////////////////////////////////////////
...
//		  	  Animal interface above to have everything working ok)
		...
		public DogAndCat(final Animal dog,
						 final Cat cat) {
			_dog = dog;
			_cat = cat;
		}
...
/////////////////////////////////////////////////////////////////////////////////////////
	private static ObjectMapper _createObjectMapper() {
		...
		jsonMapper.configure(MapperFeature.INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES,false);
