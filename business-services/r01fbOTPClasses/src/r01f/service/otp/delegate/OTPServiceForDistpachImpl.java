		...
		if ( dispatchRequest.getPresentationData().getPresentationDataType().equals(OTPTypeOfDispatch.MAIL)) {
			...
			try {
				...
				if(otpPresentationDataMail.getOtpMimeMessage() != null){
					...
					otpPresentationDataMail.getOtpMimeMessage().replaceOtpValue(otpData.getValue().asString());
					MimeMessage msg = otpPresentationDataMail.getOtpMimeMessage().toMimmeMessage();
