...
/**
 * Some org.apache.commons.lang3.StringUtils methods extracted here just
 * to be used in Strings utility type and remove the dependency with apache.commons.lang
 * so Strings can be GWT compilable
 */
class StringUtils {
    /**
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static String rightPad(final String str,final int size,final String padStr) {
        ...
        String thePadStr = StringUtils.isEmpty(padStr) ? " "
        											   : padStr;
        int padLen = thePadStr.length();
        ...
        if (pads == padLen) {
            ...
            char[] padChars = thePadStr.toCharArray();
    ...
    public static String leftPad(final String str,final int size,final String padStr) {
        if (str == null) return null;
        String thePadStr = StringUtils.isEmpty(padStr) ? " " : padStr;
