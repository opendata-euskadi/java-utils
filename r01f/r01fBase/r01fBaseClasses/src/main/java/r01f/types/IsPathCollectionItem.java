...
@Accessors(prefix="_")
public class IsPathCollectionItem<P extends IsPath> 
...
//	CONSTRUCTOR                                                                          
/////////////////////////////////////////////////////////////////////////////////////////
	public IsPathCollectionItem() {
		// default no-args constructor
	}
	public IsPathCollectionItem(final P path) {
		_id = PathCollectionItemID.forId(PathCollectionItemID.supplyId());
		_path = path;
	}
	public IsPathCollectionItem(final PathCollectionItemID id,final P path) {
		_id = id;
		_path = path;
	}
	public IsPathCollectionItem(final P path,
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public Tagged<String> asTaggeable() {
		return new TaggeableDelegate<String,IsPathCollectionItem<P>>(this);
	}
	@Override
