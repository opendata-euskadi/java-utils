...
@MetaDataForType(modelObjTypeCode = HasFieldsMetaData.HAS_LANGUAGE_DEPENDENT_MODEL_OBJECT_TYPE_CODE,
			     description = {
						@DescInLang(language=Language.SPANISH, value="Un objeto de modelo que tiene un nombre dependiente del idioma"),
						@DescInLang(language=Language.BASQUE, value="[eu] A model object that has a language-dependent name"),
						@DescInLang(language=Language.ENGLISH, value="A model object that has a language-dependent name")
			     })
@GwtIncompatible
@Accessors(prefix="_")
public interface HasMetaDataForHasLanguageDependentName
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public static enum SEARCHABLE_METADATA 
		...
		NAME_BY_LANGUAGE ("nameByLanguage");
