...
public class KrbAsRep extends KrbKdcRep {
    ...
    public r01f.httpclient.jsse.security.krb5.internal.ccache.Credentials setCredentials() {
        return new r01f.httpclient.jsse.security.krb5.internal.ccache.Credentials(rep);
    }
}
