...
import r01f.httpclient.jsse.security.provider.certpath.X509CertificatePair;
import r01f.httpclient.jsse.security.util.Cache;
...
is)
        ...
        throws IOException
    {
       ...
       // BASE64Decoder decoder = new BASE64Decoder();
        ...
        return org.apache.commons.codec.binary.Base64.decodeBase64(strBuf.toString());
