...
class NTLMAuthentication extends AuthenticationInfo {
	 ...
	 *
	 */
	private static final long serialVersionUID = -7901150746698140374L;
    ...
    static {
        defaultDomain = java.security.AccessController.doPrivileged(
            new GetPropertyAction("http.auth.ntlm.domain",
                                                      "domain"));
    };
    ...
    private void init0() {
        ...
        try {
            ...
            md4 = r01f.httpclient.jsse.security.provider.MD4.getInstance();
    ...
    */
    ...
    private String buildType3Msg (String challenge) throws GeneralSecurityException,
       ...
       // byte[] type2 = (new sun.misc.BASE64Decoder()).decodeBuffer (challenge);
        byte[] type2 = Base64.decodeBase64(challenge);
        ...
        String result = "NTLM " + Base64.encodeBase64String (msg);
        return result;
    }
