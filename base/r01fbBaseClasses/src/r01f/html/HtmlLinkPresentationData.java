...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	@Getter @Setter private HtmlLinkAccessKey _accessKey;
    /**
...
//  
/////////////////////////////////////////////////////////////////////////////////////////
	public HtmlLinkPresentationData() {
		// defautl no-args constructor
	}
	public HtmlLinkPresentationData(final HtmlLinkPresentationData other) {
		_id = other.getId() != null ? HtmlElementId.forId(other.getId().asString()) : null;
		_title = Strings.isNOTNullOrEmpty(other.getTitle()) ? new String(other.getTitle()) : null;
		_targetResourceData = other.getTargetResourceData() != null ? new HtmlLinkTargetResourceData(other.getTargetResourceData()) : null;
		_accessKey = other.getAccessKey() != null ? new HtmlLinkAccessKey(other.getAccessKey()) : null;
		_newWindowOpeningMode = other.getNewWindowOpeningMode() != null ? new HtmlLinkWindowOpeningMode(other.getNewWindowOpeningMode()) : null;
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public HtmlLinkPresentationData withId(final HtmlElementId id) {
		_id = id;
		return this;
	}
	...
	public HtmlLinkPresentationData withStyleClasses(final CSSStyleClassName... classes) {
		if (CollectionUtils.hasData(classes)) {
			_styleClasses = Lists.newArrayList(classes);
		}
		return this;
	}
	public HtmlLinkPresentationData addStyleClass(final CSSStyleClassName cssClassName) {
	...
	public HtmlLinkPresentationData withJavaScriptEvents(final HtmlElementJSEvent... events) {
		_javaScriptEvents = Lists.newArrayList(events);
		return this;
	}
	public HtmlLinkPresentationData addJavaScriptEvent(final HtmlElementJSEvent event) {
		if (_javaScriptEvents == null) _javaScriptEvents = Lists.newArrayList();
		_javaScriptEvents.add(event);
		return this;
	}
	public HtmlLinkPresentationData withOrCombinedMediaQueries(final MediaQuery... orCombinedMediaQueries) {
	...
	public HtmlLinkPresentationData addOrCombinedMediaQuery(final MediaQuery qry) {
