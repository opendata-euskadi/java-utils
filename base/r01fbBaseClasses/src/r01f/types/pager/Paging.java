...
///////////////////////////////////////////////////////////////////////////////////////////
     ...
     * @param newPageSize the number of items in each search results page
     * @param totalItems the number of items returned by the search
     * @param currPage the current page
     */
    public Paging(final int newPageSize,
     ...
     * @param newPageSize the number of items in each search results page
     * @param newNavBarWindowItems the number of pages shown in the nav bar (the window size)
     * @param totalNumberOfItems the number of items returned by the search
     * @param currPage the current page
     */
    public Paging(final int newPageSize,final int newNavBarWindowItems,
    			  final int totalNumberOfItems,
    			  final int currPage) throws IllegalArgumentException {
        Preconditions.checkArgument(newPageSize > 0 || newNavBarWindowItems > 0,"The page size or the block of pages size cannot be zero or negative");
        Preconditions.checkArgument(totalNumberOfItems >= 0,"The total number of items must be a greater than zero");
        _pageItems = newPageSize;					
        _navBarWindowItems = newNavBarWindowItems;
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public int getPageFirstItem(final int page) throws IllegalArgumentException {
        ...
        if (page == this.getFirstPage()) return 1;
